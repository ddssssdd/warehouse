                ...
                <table class="table table-hover" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <td>
                            ...
                            <a href="javascript:void(0);" ng-click="remove_vendor($event,item,$index);" class="btn btn-default btn-xs">
                        ...
                        <td>
                            ...
                            <a href="javascript:void(0);" ng-click="new_vendor($event)" class="btn btn-default btn-xs">
...
angular.module("Warehouse-app").controller("VendorCtrl",function($scope,httpService){
    ...
    $scope.select_vendor =function(item){
        $scope.current_vendor = item;
        $scope.load_inventory();
    }
   
    $scope.new_vendor = function(event){
        
        if ($scope.new_item.name!=''){
            var url = base_url + "/vendor/add";
